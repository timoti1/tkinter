...
def draw_board(whitecolor, blackcolor):
...
def draw_arrow(ix_from, iy_from, ix_to, iy_to, color, width = 1):
    ...
    try:
        ...
        холст.create_line(from_x, from_y, to_x, to_y, fill = color, width = width, arrow = tkinter.LAST)
